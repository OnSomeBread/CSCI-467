...
if (isset($_GET['Name']) && isset($_GET['Email']) && isset($_GET['Country']) && isset($_GET['Address']) && isset($_GET['QuoteID'])){
	...
	echo $_GET['Name'];
	// TODO
$n = $pdo->query("INSERT INTO CustomerData (Name, Email, Country, Address, QuoteID) VALUES (" . trim(strip_tags($_GET['Name'])) . ", " . $_GET['Email'] . ", " . $_GET['Country'] . ", " . $_GET['Address'] . ", " . (int)$_GET['QuoteID'] . ");");
}
$login = "";
